let homeButton = document.getElementsByClassName('home-button');
let contactButton = document.getElementsByClassName('contact-button');
let projectButton = document.getElementsByClassName('projects-button');
...
function contactText() {
    mainBodyText.innerHTML = 
    `
    <h2 class="heading">How to contact me!</h2>
    <ul id="contact-list">
...
function projectText() {
    mainBodyText.innerHTML = 
    `
    <h2 class="heading">Here are a few of my projects!</h2>
    <ul id="project-list">
        <li>
...
homeButton[0].onclick = homeText;
contactButton[0].onclick = contactText;
projectButton[0].onclick = projectText;

homeButton[1].onclick = homeText;
contactButton[1].onclick = contactText;
projectButton[1].onclick = projectText;